...
def init_args(params=None):
    ...
    parser.add_argument('--root_path', default='D:\\PROJECT_TW\\git\\data\\qrdetect', 
                        type=str, help='data root path')
    parser.add_argument('--dataset', default='GTDB', choices=['GTDB'],
                        type=str, help='choose GTDB')
    parser.add_argument('--dataset_root', default='D:\\PROJECT_TW\\git\\data\\qrdetect',
    ...
    parser.add_argument('--log_dir', default="D:\\PROJECT_TW\\git\\data\\qrdetect\\log", type=str,
