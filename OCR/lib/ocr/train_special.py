...
from normal_file_dataset import OcrFileDataset, adjustCollate
...
def train(args):
    ...
    train_dataset = OcrFileDataset(root=args.data_root, 
                          split='train',
                          transform=ImgTransform(data_root=args.data_root))       

    valid_dataset = OcrFileDataset(root=args.data_root, 
                          split='valid',
                          transform=ImgTransform(data_root=args.data_root))      
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root',default=r'D:\PROJECT_TW\git\data\ocr\special', type=str, help='path of the data')
    # parser.add_argument('--alpha', default='abcdefghz', type=str)
    parser.add_argument('--alpha', default='tfyez', type=str)
    ...
    parser.add_argument("--save_dir", type=str, default=r"D:\PROJECT_TW\git\data\ocr\special\ckpts", help="The dir to save checkpoints")
