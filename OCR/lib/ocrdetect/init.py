...
def init_args(params=None):
    ...
    parser.add_argument('--root_path', default='D:\\PROJECT_TW\\git\\data\\ocr', 
                        type=str, help='data root path')
    parser.add_argument('--dataset', default='GTDB', choices=['GTDB'],
                        type=str, help='choose GTDB')
    parser.add_argument('--data_root', default='D:\\PROJECT_TW\\git\\data\\ocr\\lmdb',
    ...
    parser.add_argument('--log_dir', default="D:\\PROJECT_TW\\git\\data\\ocr\\log", type=str,
