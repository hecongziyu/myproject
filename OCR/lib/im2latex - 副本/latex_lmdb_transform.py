...
class RandomSize(object):
    def __init__(self, min_radio=0.6, max_radio=0.7, min_size=900):
    ...
    def __call__(self, image):
        ...
        radio = random.uniform(min_radio, self.max_radio)
...
class ImgTransform(object):
    def __init__(self, window=(300,500), max_height=300, max_width=500, min_size=900):
        ...
        self.augment = Compose([
                RemoveWhiteBoard(),
                RandomSize(min_size=self.min_size),
