...
def main():
    ...
    parser.add_argument("--save_dir", type=str,
                        default=r"D:\PROJECT_TW\git\data\im2latex\ckpts", help="The dir to save checkpoints")
    ...
    if from_check_point:
        ...
        checkpoint = torch.load(join(args.save_dir,'best_ckpt.pt'))
...
if __name__ == "__main__":
    ...
    '''
    # 注意训练时先采用teaching-force(可提高学习出来的速度), 当loss 下降到一定程度时，再改为inv_sigmoid方式。
    main()
