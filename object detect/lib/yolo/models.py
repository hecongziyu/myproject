    ...
    for i, mdef in enumerate(module_defs):
        ...
        if mdef['type'] == 'convolutional':
            ...
            if k == 2 and stride == 1:  # yolov3-tiny
                # https://zhuanlan.zhihu.com/p/95368411  4种边界Padding方法 指定tensor的四个方向上的填充数
            ...
            if ONNX_EXPORT:  # explicitly state size, avoid scale_factor
                ...
                # http://www.manongjc.com/detail/11-mxprufsktfjqhpy.html 上采样
                # https://www.cnblogs.com/miaozhijuan/p/12454205.html yolo3 上采样的理解
                # 上采样相当于特征融合,说明就是上层的yolo层融合下层yolo层的深度信息，上层可能只是一些颜色
                # 形状之类的浅层信息，下层是一些抽象深层信息例如人、狗等复杂语义.
                # 为了实现细粒度的检测，第79层的特征图又开始作上采样（从79层往右开始上采样卷积），然后与第61层特
                # 征图融合（Concatenation），这样得到第91层较细粒度的特征图，同样经过几个卷积层后得到相对输入图像
                # 16倍下采样的特征图。它具有中等尺度的感受野，适合检测中等尺度的对象。
...
class YOLOLayer(nn.Module):
    ...
    def create_grids(self, ng=(13, 13), device='cpu'):
        ...
        if not self.training:
            print('build xy offset .....................')
            # meshgrid()函数常用于生成二维网格，比如图像的坐标点。 https://www.jianshu.com/p/e1c8e51bc9b3
...
class Darknet(nn.Module):
    ...
    def forward_once(self, x, augment=False, verbose=False):
        ...
        if self.training:  # train
            ...
            # print('len yolo_out:', len(yolo_out),'\n', 'inf size:' ,yolo_out[0].size(), ' train  out size:', yolo_out[1].size())
    ...
    # https://github.com/ultralytics/yolov3/issues/807 fuse
    def fuse(self):
