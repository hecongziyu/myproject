...
path = 'D:\\PROJECT_TW\\git\\data\\objdetect\\source\\img'
gt_path = 'D:\\PROJECT_TW\\git\\data\\objdetect\\source\\label'
out_path = 'D:\\PROJECT_TW\\git\\data\\objdetect\\source\\re_image'
out_label_path = 'D:\\PROJECT_TW\\git\\data\\objdetect\\source\\label_tmp'
...
for file in files:
    ...
    for line in lines:
        ...
        with open(os.path.join(out_label_path, stem) + '.txt', 'a') as f:
