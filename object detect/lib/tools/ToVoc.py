...
if __name__ == '__main__':
    _outdir = 'D:\\PROJECT_TW\\git\\data\\objdetect\\source\\TEXTVOC\\VOC2007'
    _draw = bool(0)
    _dest_label_dir, _dest_img_dir, _dest_set_dir = build_voc_dirs(_outdir)
    _doncateothers = bool(1)
    for dset in ['train']:
        _labeldir = 'D:\\PROJECT_TW\\git\\data\\objdetect\\source\\label_tmp'
        _imagedir = 'D:\\PROJECT_TW\\git\\data\\objdetect\\source\\re_image'
