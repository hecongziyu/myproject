...
if __name__ == '__main__':
    ...
    parser.add_argument("--embed_dim", type=int,default=128, help="embed size")
    ...
    parser.add_argument("--save_dir", type=str, default="/myproject/data/testpaper/weights/best_classify.pt", help="The dir to save checkpoints")    
